/*
  # Initial Schema Setup for Shababna Platform

  1. New Tables
    - `users` - User accounts with authentication information
    - `projects` - Project information with title, description, and metadata
    - `analytics` - Analytics data for tracking metrics
...
VALUES 
    ('Young Leaders Project 2024', 'Leadership development program for youth', 'education', '2024'),
    ('Community Health Initiative', 'Initiative to promote community health', 'health', '2024'),
    ('Green Reforestation Project', 'Tree planting project', 'environment', '2023')
